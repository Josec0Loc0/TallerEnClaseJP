...
namespace TallerEnClaseJP.Controllers
{
    public class JugadorsController : Controller
    {
        ...
        public JugadorsController(TallerEnClaseJPContext context)
        {
            _context = context;
        }
        ...
        {
            var tallerEnClaseJPContext = _context.Jugador.Include(j => j.Equipo);
        ...
        {
            ViewData["EquipoId"] = new SelectList(_context.Set<Equipo>(), "IdEquipo", "Ciudad");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Posición,Edad,Titulos,EquipoId")] Jugador jugador)
        {
            ...
            ViewData["EquipoId"] = new SelectList(_context.Set<Equipo>(), "IdEquipo", "Ciudad", jugador.EquipoId);
            return View(jugador);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Posición,Edad,Titulos,EquipoId")] Jugador jugador)
        {
            if (id != jugador.Id)
            {
                return NotFound();
