...
namespace TallerEnClaseJP.Controllers
{
    public class EstadiosController : Controller
    {
        ...
        public EstadiosController(TallerEnClaseJPContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdEstadio,Direccion,CiudadEstadio,Capacidad")] Estadio estadio)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdEstadio,Direccion,CiudadEstadio,Capacidad")] Estadio estadio)
        {
